...
- **Flexible turn endings.** The agent may call `finish` or `ask_user`, or end with substantive prose when that fully answers the user. Empty non-substantive turns get one retry, then a visible error.
