...
import { WORKSPACE_DOTDIR } from '../constants.js';
...
export function vectorIndexPath(workspacePath: string): string {
  return `${workspacePath}/${WORKSPACE_DOTDIR}/${VECTOR_INDEX_SUBDIR}/${VECTOR_INDEX_DB}`;
}
