...
import { shouldSynthesizePartialToolEntry } from '../../timeline/reducer/partialToolVisibility.js';
...
import {
  ...
  type Row,
  type ToolGroupChild
} from '../../timeline/reducer/deriveRows.js';
import { ToolGroupRow } from '../../timeline/rows/ToolGroupRow.js';
import { FileEditGroupRow } from '../../timeline/rows/FileEditGroupRow.js';
import { ReasoningPanel, TextPanel } from './iterationPanels.js';
import { ScopeFileStrip } from '../../timeline/delegation/ScopeFileStrip.js';
 ...
 */
function buildSubAgentFlow(snap: SubAgentSnapshot): FlowGroup[] {
