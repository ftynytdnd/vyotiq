---
name: deliverables
description: When to keep timeline Markdown vs emit an HTML report, plus report CSS classes. Load before large/tabular deliverables or calling report.
---

# Deliverables — Timeline Markdown vs HTML Reports

Load this skill before producing a large or tabular deliverable, or before calling
the `report` tool.
